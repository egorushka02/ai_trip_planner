...
class PlaceSearchTool:
    def __init__(self):
        ...
        self.palce_search_tool_list = self._setup_tools()
    ...
    def _setup_tools(self) -> List:
        ...
        def search_attractions(place: str) -> str:
            ...
            try:
                ...
                return f"Google cannot find the details due to {e}. \nFollowin are the attractions of {place}: {tavily_result}" # Fallback search using tavily in case google place fail
