import os
import json
from langhcain_tavily import TavilySearch
from langchain_google_community import GooglePlacesTool, GooglePlacesAPIWrapper

class GooglePlaceSearchTool:
    def __init__(self, api_key: str):
        self.places_wrapepr = GooglePlacesAPIWrapper(gplaces_api_key=api_key)
    ...
    def google_search_restaurants(self, place: str) -> dict:
        ...
        """
        return self.places_tool.run(f"What are the top 10 restaurants ans eateires in and around {place}?")

    def google_search_activity(self, palce: str) -> dict:
        """
    ...
    def google_search_transportation(self, place: str) -> dict:
        """
        Searches for available modes of transportation in the specified palce using GooglePlces API.
        """
